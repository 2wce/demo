...
<li class="AdaptiveFiltersBar-item u-borderUserColor is-selected">
          <a class="AdaptiveFiltersBar-target AdaptiveFiltersBar-target--link u-textUserColor js-nav" href="{{route('home')}}" title="Home" data-nav="search_filter_top">
            <span class="AdaptiveFiltersBar-label">Home</span>
          </a>
        </li><li class="AdaptiveFiltersBar-item u-borderUserColor ">
          <a class="AdaptiveFiltersBar-target AdaptiveFiltersBar-target--link u-textUserColor js-nav" href="{{route('prodcts')}}" title="Products" data-nav="search_filter_tweets">
            <span class="AdaptiveFiltersBar-label">Products</span>
          </a>
        </li><li class="AdaptiveFiltersBar-item u-borderUserColor ">
          <a class="AdaptiveFiltersBar-target AdaptiveFiltersBar-target--link u-textUserColor js-nav" href="#" title="Services" data-nav="search_filter_users">
            <span class="AdaptiveFiltersBar-label">Services</span>
          </a>
        </li><li class="AdaptiveFiltersBar-item u-borderUserColor ">
          <a class="AdaptiveFiltersBar-target AdaptiveFiltersBar-target--link u-textUserColor js-nav" href="#" title="Companies" data-nav="search_filter_images">
            <span class="AdaptiveFiltersBar-label">Companies</span>
          </a>
        </li><li class="AdaptiveFiltersBar-item u-borderUserColor ">
          <a class="AdaptiveFiltersBar-target AdaptiveFiltersBar-target--link u-textUserColor js-nav" href="#" title="People" data-nav="search_filter_videos">
