...
#anch
{
    ...
    z-index: 10;
       ...
       <div class="panel-body">
         <form class="form-vertical" role="form" enctype="multipart/form-data" method="post" action="{{ route('test') }}">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-8">
              ...
              @endif
                       ...
                       <div class="form-group">
                           <button type="submit" class="btn btn-default" style="float:right" id="kuda-test">Share</button>
                       </div>
...
@endforeach
         ...
         <div class="radio block"><input name="condition" type = "hidden" value ="New" type="radio" checked / > </div>
     ...
     <div class="form-group">
       ...
       <div class="form-group">
<button tupe="submit" class="btn btn-default"  style="float:right" id="kuda-test">Share</button>
